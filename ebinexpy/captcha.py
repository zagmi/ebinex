...
class Captcha:
    ...
    def __check_eval_status(self):
        try:
            checkbox = self.__driver.find_element(By.XPATH, '//*[@id="recaptcha-anchor" and @aria-checked="true"]')
            if checkbox:
                return True
    ...
    def __request_audio_version(self):
        self.__driver.switch_to.default_content()
        self.__driver.switch_to.frame(self.__driver.find_element(By.XPATH, './/iframe[@title="recaptcha challenge expires in two minutes"]'))
